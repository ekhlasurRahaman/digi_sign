  ...
  <body>
   ...
   <!--header start-->
	...
	<div class="form-signin wow fadeInUp">
		<h2 class="form-signin-heading">Your Own Signature</h2>
    <div style="width:350px;height:auto;margin:50px auto;padding: 20px 0;background-color:#616D7E;">
		...
		<center><button class="btn btn-success" name="get" type="button" id="get">View Signature</button></center>
