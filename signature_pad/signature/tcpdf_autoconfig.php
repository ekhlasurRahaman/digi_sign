...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'eDigiSign.jpg')) {
		$tcpdf_header_logo = 'eDigiSign.jpg';
	}
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'eDigiSign');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'eDigiSign');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'eDigiSign Demo');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by eDigiSign\nwww.s.eDigiSign.org");
}
